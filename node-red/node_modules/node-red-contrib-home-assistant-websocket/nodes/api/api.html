...
<script type="text/javascript">RED.nodes.registerType("ha-api",{category:"home_assistant",color:"#52C0F2",inputs:1,outputs:1,icon:"plane.png",paletteLabel:"API",label:function(){return this.name||"API"},labelStyle:nodeVersion.labelStyle,defaults:{name:{value:""},server:{value:"",type:"server",required:!0},debugenabled:{value:!1},protocol:{value:"websocket"},method:{value:"get"},path:{value:""},data:{value:""},dataType:{value:"json"},location:{value:"payload"},locationType:{value:"msg"},responseType:{value:"json"}},oneditprepare:function(){const e=$("#node-input-server"),t=function(){let t;RED.nodes.eachConfig(e=>{"server"!==e.type||t||(t=e.id)}),t&&e.val(t)};this.server||t(),$("#node-input-data").typedInput({types:["json","jsonata"],typeField:"#node-input-dataType"}).typedInput("width","68%"),$("#node-input-protocol").on("change",(function(){const e="http"===$(this).val();$(".http").toggle(e),$("#node-input-method").trigger("change")})).trigger("change"),$("#node-input-method").on("change",(function(){const e="http"===$("#node-input-protocol").val()&&"get"===$("#node-input-method").val()?"Params":"Data";$("#data-label").text(e)})),$("#node-input-location").typedInput({types:["msg","flow","global",{value:"none",label:"None",hasValue:!1}],typeField:"#node-input-locationType"}).typedInput("width","68%")}});</script>
