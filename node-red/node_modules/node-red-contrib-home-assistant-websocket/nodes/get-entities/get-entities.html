...
<script type="text/javascript">RED.nodes.registerType("ha-get-entities",{category:"home_assistant",color:"#52C0F2",inputs:1,outputs:1,icon:"pagesearch.png",paletteLabel:"get entities",label:function(){return this.name||"get entities"},labelStyle:nodeVersion.labelStyle,defaults:{server:{value:"",type:"server",required:!0},name:{value:""},rules:{value:[{property:"",logic:"is",value:"",valueType:"str"}]},output_type:{value:"array"},output_empty_results:{value:!1},output_location_type:{value:"msg"},output_location:{value:"payload"},output_results_count:{value:1,validate:function(t){return"random"!==$("#node-input-output_type").val()||Number.isInteger(Number(t))}}},oneditprepare:function(){const t=[{value:"is",text:"is"},{value:"is_not",text:"is not"},{value:"lt",text:"<"},{value:"lte",text:"<="},{value:"gt",text:">"},{value:"gte",text:">="},{value:"includes",text:"in"},{value:"does_not_include",text:"not in"},{value:"starts_with",text:"starts with"},{value:"in_group",text:"in group"},{value:"jsonata",text:"JSONata"}],e={value:"entity",label:"entity."},a=["str","num","bool","re","jsonata","msg","flow","global",e],o=$("#logic");let n=[];haServer.init(this,"#node-input-server"),haServer.autocomplete("properties",t=>{n=t,$(".input-property").autocomplete({source:n,minLength:0})}),o.editableList({addButton:!0,removable:!0,height:321,addItem:function(o,u,s){const l=$("<div />").appendTo(o),p=$("<div />",{style:"margin-top: 10px;"}).appendTo(o);Object.prototype.hasOwnProperty.call(s,"logic")||(s.logic="is"),$("<span />",{text:"Property",style:"padding-right: 47px;"}).appendTo(l);const i=$("<input />",{type:"text",class:"input-property",style:"margin-left: 5px;"}).appendTo(l).val(s.property);i.autocomplete({source:n,minLength:0});const r=$("<select/>",{style:"margin-right: 5px;width: auto;"}).appendTo(p).change((function(t){let o=a;switch(i.prop("disabled","jsonata"===t.target.value),t.target.value){case"is":case"is_not":break;case"lt":case"lte":case"gt":case"gte":o=["num","jsonata","msg","flow","global",e];break;case"includes":case"does_not_include":case"starts_with":case"in_group":o=["str","jsonata","msg","flow","global",e];break;case"jsonata":o=["jsonata"]}d.typedInput("types",o)}));for(var c in t)r.append($("<option></option>").val(t[c].value).text(t[c].text));const d=$("<input />",{class:"input-value",type:"text",style:"width: 70%;"}).appendTo(p).val(s.value).typedInput({types:a});d.typedInput("type",s.valueType),r.val(s.logic).trigger("change")}}),o.editableList("addItems",this.rules),$("#node-input-output_location").typedInput({types:["msg","flow","global"],typeField:"#node-input-output_location_type"}),$("#node-input-output_results_count").spinner({min:1}),$("#node-input-output_type").on("change",(function(t){switch($(".output-option").hide(),t.target.value){case"array":$("#output_empty_results").show(),$("#output_location").show();break;case"count":$("#output_location").show();break;case"random":$("#output_results_count").show(),$("#output_location").show()}})).trigger("change")},oneditsave:function(){const t=$("#logic").editableList("items"),e=this;e.rules=[],t.each((function(t){const a=$(this),o=a.find(".input-property").val(),n=a.find("select").val(),u=a.find(".input-value").typedInput("value"),s=a.find(".input-value").typedInput("type");e.rules.push({property:o,logic:n,value:u,valueType:s})}))}});</script>
<script type="text/x-red" data-template-name="ha-get-entities"><div class="form-row"><label for="node-input-name"><i class="fa fa-tag"></i> Name</label> <input type="text" id="node-input-name" placeholder="Name"></div><div class="form-row"><label for="node-input-server"><i class="fa fa-server"></i> Server</label> <input type="text" id="node-input-server"></div><div class="form-row"><ol id="logic"></ol></div><div class="form-row"><label for="node-input-output_type" style="width:160px">Output Type</label> <select id="node-input-output_type"><option value="array">Array</option><option value="count">Count</option><option value="random">Random</option><option value="split">Split</option></select></div><div class="form-row output-option" id="output_empty_results"><input type="checkbox" id="node-input-output_empty_results" style="margin-left:165px;display:inline-block;width:15px;vertical-align:top"> <label for="node-input-output_empty_results" style="width:auto">Send Empty Results</label></div><div class="form-row output-option" id="output_results_count"><label for="node-input-output_results_count" style="width:160px">Max Number of Results</label> <input type="text" id="node-input-output_results_count" style="width:150px"></div><div class="form-row output-option" id="output_location"><label for="node-input-output_location">Output Location</label> <input type="hidden" id="node-input-output_location_type"> <input type="text" id="node-input-output_location"></div></script>
